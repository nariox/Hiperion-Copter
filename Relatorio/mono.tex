...
\begin{table}
  ...
  & & Hélice 10 / 4.5  & & & Hélice 9 / 3.8 & \\

  \hline

  Sinal & Força(mN) & i(A) & Rotação(rpm) & Força(mN) & Corrente(A) & Rotação(rpm) \\
...
Porque não consigo escrever texto entre as tabelas? Alguém sabe a resposta?
