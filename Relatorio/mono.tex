...
Para gerar os parâmetros e auxiliar na construção do protótipo foram obtidas as seguintes curvas:
  \begin{itemize}
    \item força dos motores x potência(em %);
    \item autonomia x potência(em %);
   \end{itemize}
...
Para gerar as curvas, foram feitas sete medidas, cada uma com uma potência do motor, com as seguintes medidas: 10%, 20%, 40%, 50%, 60%, 80%, 100%. Com isto a força que cada motor pode executar foi medida. Juntamente com a medida da força, a corrente e a tensão também foram obtidas para calcular a potência que o motor absorve.
