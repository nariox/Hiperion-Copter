...
\begin{figure}[h!]
  \centering
  \includegraphics[width=6in]{./Figuras/ESC-interrupt.eps}
  \caption
...
H(e^{j\omega}) = \over{a}{a+b(1-e^{-j\omega}}
\end{equation}

Pode-se notar que ele possui ganho $\approx 1$ para baixas frequências e o ganho cai para $\over{a}{a+2b}$ para altas frequências.
