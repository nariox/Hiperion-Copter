...
Os algoritmos que controlam a estabilidade são PIDs não-lineares, ver a seção \ref{sec:controle} para mais detalhes.

Abaixo, um diagrama que representa esse comportamento:

\begin{figure}[h!]
  \centering
  \includegraphics[width=4in]{./Figuras/Estab-func.eps}
